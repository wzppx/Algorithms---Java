...
public class PerformanceTest {
    ...
    public void testActivitySelectionPerformance() {
        ...
        System.out.println("ActivitySelection 总耗时: " + total + " ns");
        System.out.println("ActivitySelection 平均耗时: " + (total / 3) + " ns");
    }
    ...
    public void testCoinChangePerformance() {
        ...
        System.out.println("CoinChange 总耗时: " + total + " ns");
        System.out.println("CoinChange 平均耗时: " + (total / 7) + " ns");
    }
}
